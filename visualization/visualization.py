...
class Visualization:
    ...
    def __init__(self, model_info):
        self.bestm_acc = model_info['best_model_valacc']
        self.bestm_loss = model_info['best_model_valloss']
        self.bestm_tlh = model_info['best_model_trlosshistory']
        self.bestm_vlh = model_info['best_model_vallosshistory']
        self.lastm_acc = model_info['last_model_valacc']
        self.lastm_loss = model_info['last_model_valloss']
    ...
    def __plot_loss_history(self):
        ...
        plt.legend()
        plt.show()
        print("\nBest Model Loss:", self.bestm_loss)
        print(f"Best Model Accuracy: {self.bestm_acc}\n")
        print("\nLast model results\n\n")
        ...
        plt.legend()
        plt.show()
        print("\nLast Model Loss:", self.lastm_loss)
        print(f"Last Model Accuracy: {self.lastm_acc}\n\n")
